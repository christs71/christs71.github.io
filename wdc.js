(function () {
    ...
    myConnector.getSchema = function (schemaCallback) {
        var cols = [
            {id : "date", alias:"Date", dateType : tableau.dataTypeEnum.string },
            ...
            {id : "uniqemed", alias:"Unique Medallions", dataType : tableau.dataTypeEnum.string },
            ...
            {id : "avg5", alias:"Avg Munites Per Trip", dataType : tableau.dataTypeEnum.string },
        ...
        $.getJSON("http://www.nyc.gov/html/tlc/downloads/csv/data_reports_monthly_indicators_yellow.json",function(resp) {
            ...
            for (var i = 0, len = feat.length; i<len; i++) {
                tableData.push({
                    ...
                    "avg5": feat[i]["TAvg Minutes Per Trip"],
